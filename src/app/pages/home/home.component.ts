...
products = [
  ...
  nextSlide() {
    this.currentSlide = (this.currentSlide + 1) % Math.ceil(this.products.length / 3);
  }

  prevSlide() {
    this.currentSlide = this.currentSlide === 0 
      ? Math.ceil(this.products.length / 3) - 1 
      : this.currentSlide - 1;
  }
  ...
  getCurrentProducts() {
    ...
    return this.products.slice(startIndex, startIndex + 3);
  }
